const { DirtyableTag, combine, CONSTANT_TAG } = Ember.__loader.require("@glimmer/reference");
...
export function hasTag(obj, key) {
    let meta = obj[META];
    if (!obj[META]) {
        return false;
    }
...
export function tagForProperty(obj, key, throwError = defaultErrorThrower) {
